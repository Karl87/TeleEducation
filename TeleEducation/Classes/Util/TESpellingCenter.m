...
@interface TESpellingCenter ()
- (SpellingUnit *)calcSpellingOfString: (NSString *)source;
@end

@implementation TESpellingCenter
+ (TESpellingCenter *)sharedCenter
{
    static TESpellingCenter *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[TESpellingCenter alloc]init];
    });
    return instance;
}
...
- (SpellingUnit *)calcSpellingOfString:(NSString *)source
{
    ...
    for (NSInteger i = 0; i < [source length]; i++)
    {
        ...
        NSString *pinyin = [[TEPinyinConverter sharedConverter] toPinyin:word];
